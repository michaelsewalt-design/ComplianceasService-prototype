...
const valid = verifyToken(token, process.env.INCIDENT_AUTH_SECRET);
...
const correctPassword = process.env.INCIDENT_SITE_PASSWORD;
if (!correctPassword) {
...
attempts.delete(ip);
const token = generateToken(process.env.INCIDENT_AUTH_SECRET);
